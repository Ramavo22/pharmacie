    ...
    <div class="container">
        ...
        <form action="Traitement" method="post" class="form-inline">
            ...
            <div class="form-group">
                <label for="lab-label">Nom du Laboratoire :</label>
                <input type="text" name="label" id="lab-label" class="form-control" required>
            </div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <%-- Récupération et affichage des laboratoires --%>
                <c:forEach var="lab" items="${laboratoires}">
                    <tr>
                        <td>${lab.id}</td>
                        <td>${lab.label}</td>
                        <td>
